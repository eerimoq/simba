...
.. image:: ../images/boards/raspberry-pi-pinout.png
   :width: 50%
   :target: ../_images/raspberry-pi-pinout.png

.. include:: extra/xvisor_raspberry_pi_3.rst
...
Read more about board specific functionality in the :doc:`Xvisor Raspberry Pi 3
<../library-reference/boards/xvisor_raspberry_pi_3>` module documentation in the
Library Reference.
...
+==========================+===========+===========+
| minimal-configuration    |     10288 |      3776 |
+--------------------------+-----------+-----------+
| default-configuration    |     85408 |     38264 |
+--------------------------+-----------+-----------+
...
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_HARNESS_MOCK_ENTRIES_MAX_                      |  1024                                               |
+--------------------------------------------------------+-----------------------------------------------------+
...
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_THRD_IDLE_STACK_SIZE_                          |  2048                                               |
+--------------------------------------------------------+-----------------------------------------------------+
...
:doc:`xvisor_virt_v8<../library-reference/mcus/xvisor_virt_v8>`
