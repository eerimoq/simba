...
- :doc:`../library-reference/drivers/network/icsp_soft`
...
Read more about board specific functionality in the :doc:`DEF CON 26 Badge
<../library-reference/boards/defcon26_badge>` module documentation in the
Library Reference.
...
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_THRD_IDLE_STACK_SIZE_                          |  256                                                |
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_THRD_MONITOR_STACK_SIZE_                       |  2048                                               |
+--------------------------------------------------------+-----------------------------------------------------+
...
:doc:`pic32mm0256gpm048<../library-reference/mcus/pic32mm0256gpm048>`
...
.. _CONFIG_DHT_COMMAND_READ: ../user-guide/configuration.html#c.CONFIG_DHT_COMMAND_READ
...
.. _CONFIG_ICSP_SOFT: ../user-guide/configuration.html#c.CONFIG_ICSP_SOFT
