...
.. image:: ../images/boards/nrf52_dk_pinout_armmbed_enabled_v2.png
   :width: 50%
...
- :doc:`../library-reference/drivers/gnss`
- :doc:`../library-reference/drivers/hx711`
...
- :doc:`../library-reference/drivers/xbee`

Library Reference
-----------------

Read more about board specific functionality in the :doc:`nRF52840-PDK
<../library-reference/boards/nrf52840_pdk>` module documentation in the
Library Reference.
...
+==========================+===========+===========+
| minimal-configuration    |      2048 |      1672 |
+--------------------------+-----------+-----------+
| default-configuration    |     66304 |      5474 |
+--------------------------+-----------+-----------+
...
:doc:`nrf52840<../library-reference/mcus/nrf52840>`
