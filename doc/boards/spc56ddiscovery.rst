...
.. image:: ../images/boards/spc56d-discovery-pinout.png
   :width: 50%
   :target: ../_images/spc56d-discovery-pinout.png

.. include:: extra/spc56ddiscovery.rst
...
Read more about board specific functionality in the :doc:`SPC56D Discovery
<../library-reference/boards/spc56ddiscovery>` module documentation in the
Library Reference.
...
+==========================+===========+===========+
| minimal-configuration    |     13628 |       919 |
+--------------------------+-----------+-----------+
| default-configuration    |     86764 |      5793 |
+--------------------------+-----------+-----------+
...
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_NVM_EEPROM_SOFT_FLASH_DEVICE_INDEX_            |  1                                                  |
+--------------------------------------------------------+-----------------------------------------------------+
...
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_SYSTEM_INTERRUPT_STACK_SIZE_                   |  256                                                |
+--------------------------------------------------------+-----------------------------------------------------+
...
:doc:`spc56d40l1<../library-reference/mcus/spc56d40l1>`
