...
.. image:: ../images/boards/esp01-pinout.png
   :width: 50%
...
+==========================+===========+===========+
| minimal-configuration    |    268420 |     35648 |
+--------------------------+-----------+-----------+
| default-configuration    |    313152 |     58884 |
+--------------------------+-----------+-----------+
...
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_START_FILESYSTEM_ADDRESS_                      |  0x0006b000                                         |
+--------------------------------------------------------+-----------------------------------------------------+
|  CONFIG_START_FILESYSTEM_SIZE_                         |  0x10000                                            |
+--------------------------------------------------------+-----------------------------------------------------+
