...
struct spiffs_dirent_t *spiffs_readdir(spiffs_DIR *d, struct spiffs_dirent_t *e) {
...
s32_t _spiffs_gc_quick(spiffs *fs, u16_t max_free_pages) {
#if SPIFFS_READ_ONLY
  ...
  res = _spiffs_gc_quick(fs, max_free_pages);
