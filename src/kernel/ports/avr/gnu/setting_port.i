...
extern uint8_t setting_area[CONFIG_SETTING_AREA_SIZE]
__attribute__ ((section (".eeprom")));

extern const FAR uint8_t setting_default_area[CONFIG_SETTING_AREA_SIZE];
...
static ssize_t setting_port_reset()
{
    ...
    for (i = 0; i < sizeof(setting_default_area); i++) {
        eeprom_update_byte(&setting_area[i], setting_default_area[i]);
    }
