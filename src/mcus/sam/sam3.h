...
#define SAM_DACC_MR_TRGSEL(value)       BITFIELD(SAM_DACC_MR_TRGSEL, value)
...
#define SAM_DACC_MR_REFRESH(value)      BITFIELD(SAM_DACC_MR_REFRESH, value)
#define SAM_DACC_MR_USER_SEL_POS        (16)
#define SAM_DACC_MR_USER_SEL_MASK       (0x3 << SAM_DACC_MR_USER_SEL_POS)
#define SAM_DACC_MR_USER_SEL(value)     BITFIELD(SAM_DACC_MR_USER_SEL, value)
...
#define SAM_DACC_MR_STARTUP(value)      BITFIELD(SAM_DACC_MR_STARTUP, value)
